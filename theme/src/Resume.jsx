...
// Memoized work item component to prevent unnecessary re-renders
const WorkItem = React.memo(function WorkItem({ job, index }) {
  ...
  return React.createElement(
    ...
    work.length > 0 &&
      React.createElement(
        ...
        work.map((job, index) =>
          React.createElement(WorkItem, { key: index, job, index }),
        ),
      ),
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                edu.studyType &&
                  React.createElement(StudyType, null, edu.studyType),
            ...
            edu.score &&
              React.createElement(ItemMeta, null, "GPA: ", edu.score),
            edu.courses &&
        ...
        React.createElement(
          ...
          volunteer.map((vol, index) =>
            React.createElement(
              ...
              vol.summary &&
                React.createElement(ItemDescription, null, vol.summary),
            ),
          ),
        ),
      ),
          ...
          awards.map((award, index) =>
            React.createElement(
              ...
              React.createElement(
                ...
                award.awarder,
                award.date &&
                  React.createElement(React.Fragment, null, " • ", award.date),
              ),
              award.summary &&
                React.createElement(ItemDescription, null, award.summary),
            ),
          ),
        ),
      ),
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                null,
                pub.url
                  ? React.createElement(Link, { href: pub.url }, pub.name)
                  : pub.name,
              ),
              React.createElement(
                ItemMeta,
            ...
            pub.summary &&
              React.createElement(ProjectDescription, null, pub.summary),
          ),
        ),
      ),
      ...
      React.createElement(
        ...
        references.map((ref, index) =>
          React.createElement(
            ...
            ref.reference &&
              React.createElement(ItemDescription, null, ref.reference),
          ),
        ),
      ),
  );
